...
func NewServiceInformer(kif informers.SharedInformerFactory, cc *Controller) cache.SharedInformer {
...
func NewIngressInformer(kif informers.SharedInformerFactory, cc *Controller) cache.SharedInformer {
...
func NewEndpoinsInformer(kif informers.SharedInformerFactory, cc *Controller) cache.SharedInformer {
